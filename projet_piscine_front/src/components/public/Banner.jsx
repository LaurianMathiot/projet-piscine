  ...
  return (
    <section className="banner-section">
      <div className="main-container">
        ...
        {/* <div className="software-icons-wrap">
          <img
            className="software-icons"
            src="./adobeicons/ps.svg"
            alt="photoshop-icon"
          />
          <img
            className="software-icons"
            src="./adobeicons/ai.svg"
            alt="illustrator-icon"
          />
          <img
            className="software-icons"
            src="./adobeicons/id.svg"
            alt="indesign-icon"
          />
          <img
            className="software-icons"
            src="./adobeicons/pr.svg"
            alt="premiere-icon"
          />
          <img
            className="software-icons"
            src="./adobeicons/ae.svg"
            alt="aftereffect-icon"
          />
        </div> */}
      </div>
    </section>
