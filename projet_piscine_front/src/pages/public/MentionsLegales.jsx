    ...
    <>
      ...
      <section className="mentions-section">
        ...
        <p>
          ...
          du site laurianmathiot.fr l’identité des différents intervenants dans
          le cadre de sa réalisation et de son suivi : <br />
          Propriétaire : Laurian Mathiot – 81845383900016
          <br />
          Créateur : Laurian Mathiot <br />
          Responsable publication : Laurian Mathiot – contact@laurianmathiot.fr{" "}
          <br />
          Le responsable publication est une personne physique ou une personne
          morale. <br />
          Webmaster : Laurian Mathiot – contact@laurianmathiot.fr <br />
        ...
        <p>
          L’utilisation du site laurianmathiot.fr implique l’acceptation pleine
          ...
          complétées à tout moment, les utilisateurs du site laurianmathiot.fr
          ...
          décidée par Laurian Mathiot, qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
          Le site laurianmathiot.fr est mis à jour régulièrement par Laurian
          Mathiot. De la même façon, les mentions légales peuvent être modifiées
        ...
        <p>
          Le site laurianmathiot.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société. Laurian Mathiot
          s’efforce de fournir sur le site laurianmathiot.fr des informations
          ...
          informations indiquées sur le site laurianmathiot.fr sont données à
          titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site laurianmathiot.fr ne sont pas
        ...
        <p>
          Laurian Mathiot est propriétaire des droits de propriété
          ...
          sauf autorisation écrite préalable de : Laurian Mathiot. Toute
        ...
        <p>
          Laurian Mathiot ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site laurianmathiot.fr, et résultant soit de l’utilisation d’un
          matériel ne répondant pas aux spécifications indiquées au point 4,
          soit de l’apparition d’un bug ou d’une incompatibilité. Laurian
          Mathiot ne pourra également être tenue responsable des dommages
          indirects (tels par exemple qu’une perte de marché ou perte d’une
          chance) consécutifs à l’utilisation du site laurianmathiot.fr. Des
          espaces interactifs (possibilité de poser des questions dans l’espace
          contact) sont à la disposition des utilisateurs. Laurian Mathiot se
          ...
          protection des données. Le cas échéant, Laurian Mathiot se réserve
        ...
        <p>
          ...
          octobre 1995. A l’occasion de l’utilisation du site laurianmathiot.fr,
          peuvent êtres recueillies : l’URL des liens par l’intermédiaire
          desquels l’utilisateur a accédé au site laurianmathiot.fr, le
          fournisseur d’accès de l’utilisateur, l’adresse de protocole Internet
          (IP) de l’utilisateur. En tout état de cause Laurian Mathiot ne
          ...
          laurianmathiot.fr. L’utilisateur fournit ces informations en toute
          connaissance de cause, notamment lorsqu’il procède par lui-même à leur
          saisie. Il est alors précisé à l’utilisateur du site laurianmathiot.fr
          ...
          de l’utilisateur du site laurianmathiot.fr n’est publiée à l’insu de
          l’utilisateur, échangée, transférée, cédée ou vendue sur un support
          quelconque à des tiers. Seule l’hypothèse du rachat de Laurian Mathiot
          ...
          l’utilisateur du site laurianmathiot.fr. Le site n’est pas déclaré à
          la CNIL car il ne recueille pas d’informations personnelles. . Les
        ...
        <p>
          Le site laurianmathiot.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Laurian Mathiot. Cependant, Laurian Mathiot n’a pas la possibilité de
          ...
          site laurianmathiot.fr est susceptible de provoquer l’installation de
          cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier
          de petite taille, qui ne permet pas l’identification de l’utilisateur,
          mais qui enregistre des informations relatives à la navigation d’un
          ordinateur sur un site. Les données ainsi obtenues visent à faciliter
          la navigation ultérieure sur le site, et ont également vocation à
          permettre diverses mesures de fréquentation. Le refus d’installation
          d’un cookie peut entraîner l’impossibilité d’accéder à certains
          services. L’utilisateur peut toutefois configurer son ordinateur de la
          manière suivante, pour refuser l’installation des cookies : Sous
          ...
          choisissez Bloquer tous les cookies. Validez sur Ok. Sous Firefox : en
          haut de la fenêtre du navigateur, cliquez sur le bouton Firefox, puis
          ...
          cookies. Sous Safari : Cliquez en haut à droite du navigateur sur le
          ...
          la section « Cookies », vous pouvez bloquer les cookies. Sous Chrome :
        ...
        <p>
          Tout litige en relation avec l’utilisation du site laurianmathiot.fr
